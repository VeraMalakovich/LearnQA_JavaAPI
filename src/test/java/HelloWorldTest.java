...
public class HelloWorldTest {
    ...
    @Test
    public void testResponseCode303True() {
        Response response = RestAssured
                .given()
                .redirects()
                .follow(true)
    ...
    @Test
    public void testHeaders303() {
        Response response = RestAssured
                .given()
                .redirects()
                .follow(false) //запрещаем перенаправление, чтобы просто увидеть значение заголовка Location
                .when()
                .get("https://playground.learnqa.ru/api/get_303")
                .andReturn();
    ...
    @Test
    public void testCookieTwoResponses() {
        Map<String, String> data = new HashMap<>();
        data.put("login", "secret_login");
        data.put("password", "secret_pass");
